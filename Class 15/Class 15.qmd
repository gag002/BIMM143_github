...
The CDC tracks pertussis cases numbers per year. Let's have a closer look at this data. 
...
We went from ~200,000 cases pre wP vaccine to ~1000 cases in 1976. The US switched to the aP vaccine in 1955. We start to see a big increase in 2004 to ~26,000 cases. 
...
CMI=PB make all their data freely availanble via JSON format tables from their database. 
...
Now let's get more data from CMI-PB, this time about the specimens collected.
...
Make a first plot of MFI (Mean Fluroscence Intensity- measure of how much is detected) for each antigen. 
...
Looks like we don't have data yet for all the subjects in terms of visits 8 onwards. So lets exclude these.
